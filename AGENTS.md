...
3. **`docs/FUGAS-PROVEEDOR.md`** documenta la anonimización del catálogo público. La
   ...
   **Queda una decisión pendiente del dueño:** las carpetas de imágenes antiguas siguen
   existiendo y responden si alguien conoce la URL, aunque ya no se enlacen. Borrarlas
   necesita su autorización expresa.

4. **El paso 2, la tienda**, va por su primera pieza: el carrito, ya fusionado en `main`.
   El diseño está en `docs/superpowers/specs/2026-08-26-tienda-carrito-design.md` y el
   plan ejecutado en `docs/superpowers/plans/2026-08-26-tienda-carrito.md`. Las piezas
   que faltan y qué las bloquea están en `CLAUDE.md` §11.
